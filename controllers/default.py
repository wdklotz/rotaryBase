...
def user():
	request.vars.request_is = "/"+appVars.items["version"]+"/default/user()"
...
def members():
	request.vars.request_is = "/"+appVars.items["version"]+"/default/members()"
	members = []
...
def register_address():
	request.vars.request_is = "/"+appVars.items["version"]+"/default/register_address()"
...
def edit_addresses():
	request.vars.request_is = "/"+appVars.items["version"]+"/default/edit_addresses()"
